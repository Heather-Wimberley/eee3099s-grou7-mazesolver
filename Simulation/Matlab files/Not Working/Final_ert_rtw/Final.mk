...
## 
## Makefile     : Final.mk
## Generated on : Thu Oct 13 10:54:51 2022
...
DEFINES_STANDARD = -DMODEL=Final -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_AnalogInput.o MW_arduino_digitalio.o Final.o Final_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_zcfcn.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
rt_zcfcn.o : $(START_DIR)/Final_ert_rtw/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
